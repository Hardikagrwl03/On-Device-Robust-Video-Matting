...
# Example: ./scripts/visualize.sh --tflite tflite_models/gpu/rvm_mobilenetv3_720x1280_ds_100.tflite
#
# Defaults to SVG (vector -- the sane choice for these graphs); pass
# --format png for a raster image instead. Output defaults to
# analysis/<source>/<model-basename>.<format>, where <source>
# (original/gpu) is inferred from a *directory* component of --tflite's
# path (tflite_models/<source>/...), same convention convert.py/verify.py
# use -- pass --output explicitly to override.
#
