...
android {
    namespace = "dev.hamster.rvm"
    compileSdk {
        version = release(37)
    }

    defaultConfig {
        applicationId = "dev.hamster.rvm"
        minSdk = 35
        targetSdk = 36
        versionCode = 1
        versionName = "1.0"
        ...
        ndk {
            ...
            // that is ~292 MB of native code in the APK for the ~71 MB any one device actually
            // uses. armeabi-v7a (52 MB) and x86 (84 MB) are dropped because nothing can reach
            // them: minSdk is 35, and no Android 15 device ships 32-bit-only ARM, nor are there
            // x86 Android phones. arm64-v8a covers every real device; x86_64 is kept so emulators
